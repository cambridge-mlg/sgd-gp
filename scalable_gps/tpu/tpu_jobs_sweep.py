    ...
    try:
        ...
        run_experiment_command = [
            ...
            "--command", "git clone https://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@github.com/jandylin/scalable-gaussian-processes.git; "
                        ...
                        f"python scripts/obtain_mean.py 9835d6db89010f73306f92bb9a080c9751b25d28 --config configs/default.py:{dataset_name} --config.model_name {method_name} --config.dataset_config.split {seed} --config.wandb.log --config.wandb.name trial_{dataset_name}_{method_name}_{seed} --noconfig.wandb.log_artifact",
            "--", "-t"
        ]
